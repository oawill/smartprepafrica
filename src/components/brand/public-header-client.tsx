...
export function PublicHeaderClient({ locale, t }: { locale: Locale; t: Dictionary["header"] }) {
  ...
  const navLinks = [{ label: t.home, href: "/" }];
  const examPrepLinks = [
    ...
    <header className="border-b border-border">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-5 text-sm lg:flex">
          ...
          <NavDropdown label={t.examPrep} href="/practice" links={examPrepLinks} />
