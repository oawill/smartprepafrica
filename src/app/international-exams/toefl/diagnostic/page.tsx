  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-12">
      ...
      <p className="mt-4 text-xs text-text-muted">
        ...
        performance, which SmartPrepAfrica can score automatically today. Your Writing and Speaking
        responses are recorded for practice and review, but AI evaluation for those two skills is not
        currently available — they are not included in the estimated score.
      </p>
